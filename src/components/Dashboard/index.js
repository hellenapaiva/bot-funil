...
const Dashboard = () => {
  ...
  return (
    <div className="h-full ml-14 mt-14 mb-10 md:ml-64">
      <div className="flex sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4 w-full">
        <div className=" w-full bg-lime-600 dark:bg-gray-800 shadow-lg rounded-md flex  justify-center items-center p-3 border-b-4 border-blue-600 dark:border-gray-600 text-white font-medium group">
          <div className="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
            <GiSoccerField className="text-lime-600 text-4xl" />
          </div>
          <div className="text-center">
            <p className="text-2xl ml-4">Relação de jogos no funil</p>
          </div>
        </div>
      </div>
          ...
          <div className="rounded-t mb-0 px-0 border-0">
            <div className="flex flex-wrap items-center px-4 py-2">
              <div className="relative w-full max-w-full flex-grow flex-1">
                <h3 className="font-bold text-base text-green-900 uppercase">
                  Jogos
                </h3>
              </div>
